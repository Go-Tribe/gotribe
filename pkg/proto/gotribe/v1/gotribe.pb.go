...
// 	protoc        v3.21.6
// source: gotribe/v1/gotribe.proto
...
func (x *UserInfo) Reset() {
	*x = UserInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gotribe_v1_gotribe_proto_msgTypes[0]
...
func (*UserInfo) Descriptor() ([]byte, []int) {
	return file_gotribe_v1_gotribe_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListUserRequest) Reset() {
	*x = ListUserRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gotribe_v1_gotribe_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListUserRequest) Descriptor() ([]byte, []int) {
	return file_gotribe_v1_gotribe_proto_rawDescGZIP(), []int{1}
}
...
func (x *ListUserResponse) Reset() {
	*x = ListUserResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gotribe_v1_gotribe_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListUserResponse) Descriptor() ([]byte, []int) {
	return file_gotribe_v1_gotribe_proto_rawDescGZIP(), []int{2}
}
...
func (x *ModifierExample) Reset() {
	*x = ModifierExample{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gotribe_v1_gotribe_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ModifierExample) Descriptor() ([]byte, []int) {
	return file_gotribe_v1_gotribe_proto_rawDescGZIP(), []int{3}
}
...
var File_gotribe_v1_gotribe_proto protoreflect.FileDescriptor

var file_gotribe_v1_gotribe_proto_rawDesc = []byte{
...
var (
	file_gotribe_v1_gotribe_proto_rawDescOnce sync.Once
	file_gotribe_v1_gotribe_proto_rawDescData = file_gotribe_v1_gotribe_proto_rawDesc
)

func file_gotribe_v1_gotribe_proto_rawDescGZIP() []byte {
	file_gotribe_v1_gotribe_proto_rawDescOnce.Do(func() {
		file_gotribe_v1_gotribe_proto_rawDescData = protoimpl.X.CompressGZIP(file_gotribe_v1_gotribe_proto_rawDescData)
	})
	return file_gotribe_v1_gotribe_proto_rawDescData
}

var file_gotribe_v1_gotribe_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_gotribe_v1_gotribe_proto_goTypes = []interface{}{
...
var file_gotribe_v1_gotribe_proto_depIdxs = []int32{
	...
	1, // 5: v1.GoTribe.ListUser:input_type -> v1.ListUserRequest
	2, // 6: v1.GoTribe.ListUser:output_type -> v1.ListUserResponse
...
func init() { file_gotribe_v1_gotribe_proto_init() }
func file_gotribe_v1_gotribe_proto_init() {
	if File_gotribe_v1_gotribe_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_gotribe_v1_gotribe_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gotribe_v1_gotribe_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gotribe_v1_gotribe_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gotribe_v1_gotribe_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_gotribe_v1_gotribe_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_gotribe_v1_gotribe_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_gotribe_v1_gotribe_proto_goTypes,
		DependencyIndexes: file_gotribe_v1_gotribe_proto_depIdxs,
		MessageInfos:      file_gotribe_v1_gotribe_proto_msgTypes,
	}.Build()
	File_gotribe_v1_gotribe_proto = out.File
	file_gotribe_v1_gotribe_proto_rawDesc = nil
	file_gotribe_v1_gotribe_proto_goTypes = nil
	file_gotribe_v1_gotribe_proto_depIdxs = nil
}
